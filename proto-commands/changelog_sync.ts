...
function createBaseChangelogSyncRequest(): ChangelogSyncRequest {
  return {
    changelogFile: "",
...
export const ChangelogSyncRequest = {
  encode(message: ChangelogSyncRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChangelogSyncRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseChangelogSyncRequest();
  ...
  fromJSON(object: any): ChangelogSyncRequest {
    return {
  ...
  toJSON(message: ChangelogSyncRequest): unknown {
    const obj: any = {};
    if (message.changelogFile !== "") {
  ...
  create<I extends Exact<DeepPartial<ChangelogSyncRequest>, I>>(base?: I): ChangelogSyncRequest {
    return ChangelogSyncRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ChangelogSyncRequest>, I>>(object: I): ChangelogSyncRequest {
    const message = createBaseChangelogSyncRequest();
...
export interface ChangelogSyncService {
  execute(request: ChangelogSyncRequest): Promise<Response>;
}

export const ChangelogSyncServiceServiceName = "liquibase.ChangelogSyncService";
export class ChangelogSyncServiceClientImpl implements ChangelogSyncService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || ChangelogSyncServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: ChangelogSyncRequest): Promise<Response> {
    const data = ChangelogSyncRequest.encode(request).finish();
