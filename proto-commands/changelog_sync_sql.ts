...
export interface ChangelogSyncSqlRequest {
...
function createBaseChangelogSyncSqlRequest(): ChangelogSyncSqlRequest {
  return {
    changelogFile: "",
...
export const ChangelogSyncSqlRequest = {
  encode(message: ChangelogSyncSqlRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChangelogSyncSqlRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseChangelogSyncSqlRequest();
  ...
  fromJSON(object: any): ChangelogSyncSqlRequest {
    return {
  ...
  toJSON(message: ChangelogSyncSqlRequest): unknown {
    const obj: any = {};
    if (message.changelogFile !== "") {
  ...
  create<I extends Exact<DeepPartial<ChangelogSyncSqlRequest>, I>>(base?: I): ChangelogSyncSqlRequest {
    return ChangelogSyncSqlRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ChangelogSyncSqlRequest>, I>>(object: I): ChangelogSyncSqlRequest {
    const message = createBaseChangelogSyncSqlRequest();
...
export interface ChangelogSyncSqlService {
  execute(request: ChangelogSyncSqlRequest): Promise<Response>;
}

export const ChangelogSyncSqlServiceServiceName = "liquibase.ChangelogSyncSqlService";
export class ChangelogSyncSqlServiceClientImpl implements ChangelogSyncSqlService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || ChangelogSyncSqlServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: ChangelogSyncSqlRequest): Promise<Response> {
    const data = ChangelogSyncSqlRequest.encode(request).finish();
