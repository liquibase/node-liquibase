...
export interface ChangelogSyncToTagRequest {
...
function createBaseChangelogSyncToTagRequest(): ChangelogSyncToTagRequest {
  return {
    changelogFile: "",
...
export const ChangelogSyncToTagRequest = {
  encode(message: ChangelogSyncToTagRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChangelogSyncToTagRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseChangelogSyncToTagRequest();
  ...
  fromJSON(object: any): ChangelogSyncToTagRequest {
    return {
  ...
  toJSON(message: ChangelogSyncToTagRequest): unknown {
    const obj: any = {};
    if (message.changelogFile !== "") {
  ...
  create<I extends Exact<DeepPartial<ChangelogSyncToTagRequest>, I>>(base?: I): ChangelogSyncToTagRequest {
    return ChangelogSyncToTagRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ChangelogSyncToTagRequest>, I>>(object: I): ChangelogSyncToTagRequest {
    const message = createBaseChangelogSyncToTagRequest();
...
export interface ChangelogSyncToTagService {
  execute(request: ChangelogSyncToTagRequest): Promise<Response>;
}

export const ChangelogSyncToTagServiceServiceName = "liquibase.ChangelogSyncToTagService";
export class ChangelogSyncToTagServiceClientImpl implements ChangelogSyncToTagService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || ChangelogSyncToTagServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: ChangelogSyncToTagRequest): Promise<Response> {
    const data = ChangelogSyncToTagRequest.encode(request).finish();
