...
export interface Checks_DisableRequest {
...
function createBaseChecks_DisableRequest(): Checks_DisableRequest {
  return { autoUpdate: undefined, checkName: "", checksSettingsFile: undefined, globalOptions: undefined };
}

export const Checks_DisableRequest = {
  encode(message: Checks_DisableRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Checks_DisableRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseChecks_DisableRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): Checks_DisableRequest {
    return {
  ...
  toJSON(message: Checks_DisableRequest): unknown {
    const obj: any = {};
    if (message.autoUpdate !== undefined) {
  ...
  create<I extends Exact<DeepPartial<Checks_DisableRequest>, I>>(base?: I): Checks_DisableRequest {
    return Checks_DisableRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Checks_DisableRequest>, I>>(object: I): Checks_DisableRequest {
    const message = createBaseChecks_DisableRequest();
...
export interface ChecksDisableService {
  execute(request: Checks_DisableRequest): Promise<Response>;
}

export const ChecksDisableServiceServiceName = "liquibase.pro.ChecksDisableService";
export class ChecksDisableServiceClientImpl implements ChecksDisableService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || ChecksDisableServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: Checks_DisableRequest): Promise<Response> {
    const data = Checks_DisableRequest.encode(request).finish();
