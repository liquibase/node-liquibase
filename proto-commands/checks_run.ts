...
function createBaseChecks_RunRequest(): Checks_RunRequest {
  return {
    ...
    checksScriptsEnabled: undefined,
    checksScriptsPath: undefined,
...
export const Checks_RunRequest = {
  encode(message: Checks_RunRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.checksScriptsEnabled !== undefined) {
      writer.uint32(88).bool(message.checksScriptsEnabled);
    }
    if (message.checksScriptsPath !== undefined) {
      writer.uint32(98).string(message.checksScriptsPath);
    }
    if (message.checksSettingsFile !== undefined) {
      writer.uint32(106).string(message.checksSettingsFile);
    }
    if (message.contextFilter !== undefined) {
      writer.uint32(114).string(message.contextFilter);
    }
    if (message.defaultCatalogName !== undefined) {
      writer.uint32(122).string(message.defaultCatalogName);
    }
    if (message.defaultSchemaName !== undefined) {
      writer.uint32(130).string(message.defaultSchemaName);
    }
    if (message.driver !== undefined) {
      writer.uint32(138).string(message.driver);
    }
    if (message.driverPropertiesFile !== undefined) {
      writer.uint32(146).string(message.driverPropertiesFile);
    }
    if (message.format !== undefined) {
      writer.uint32(154).string(message.format);
    }
    if (message.labelFilter !== undefined) {
      writer.uint32(162).string(message.labelFilter);
    }
    if (message.password !== undefined) {
      writer.uint32(170).string(message.password);
    }
    if (message.propertySubstitutionEnabled !== undefined) {
      writer.uint32(176).bool(message.propertySubstitutionEnabled);
    }
    if (message.reportEnabled !== undefined) {
      writer.uint32(184).bool(message.reportEnabled);
    }
    if (message.reportName !== undefined) {
      writer.uint32(194).string(message.reportName);
    }
    if (message.reportPath !== undefined) {
      writer.uint32(202).string(message.reportPath);
    }
    if (message.schemas !== undefined) {
      writer.uint32(210).string(message.schemas);
    }
    if (message.sqlParserFailSeverity !== undefined) {
      writer.uint32(216).int32(message.sqlParserFailSeverity);
    }
    if (message.url !== undefined) {
      writer.uint32(226).string(message.url);
    }
    if (message.username !== undefined) {
      writer.uint32(234).string(message.username);
    }
    if (message.verbose !== undefined) {
      writer.uint32(240).bool(message.verbose);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          message.checksScriptsEnabled = reader.bool();
          continue;
        case 12:
          if (tag !== 98) {
            break;
          ...
          message.checksScriptsPath = reader.string();
          continue;
        case 13:
          if (tag !== 106) {
            break;
  ...
  fromJSON(object: any): Checks_RunRequest {
    return {
      ...
      checksScriptsEnabled: isSet(object.checksScriptsEnabled)
        ? globalThis.Boolean(object.checksScriptsEnabled)
        : undefined,
      checksScriptsPath: isSet(object.checksScriptsPath) ? globalThis.String(object.checksScriptsPath) : undefined,
  ...
  toJSON(message: Checks_RunRequest): unknown {
    ...
    if (message.checksScriptsEnabled !== undefined) {
      obj.checksScriptsEnabled = message.checksScriptsEnabled;
    }
    if (message.checksScriptsPath !== undefined) {
      obj.checksScriptsPath = message.checksScriptsPath;
    }
    if (message.checksSettingsFile !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<Checks_RunRequest>, I>>(object: I): Checks_RunRequest {
    ...
    message.checksScriptsEnabled = object.checksScriptsEnabled ?? undefined;
    message.checksScriptsPath = object.checksScriptsPath ?? undefined;
