...
export interface ConnectService {
  execute(request: ConnectRequest): Promise<Response>;
}

export const ConnectServiceServiceName = "liquibase.ConnectService";
export class ConnectServiceClientImpl implements ConnectService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || ConnectServiceServiceName;
    this.rpc = rpc;
