...
export interface FutureRollbackCountSqlRequest {
  ...
  /** required* Number of changesets to generate rollback SQL for */
  count: number;
...
function createBaseFutureRollbackCountSqlRequest(): FutureRollbackCountSqlRequest {
  return {
...
export const FutureRollbackCountSqlRequest = {
  encode(message: FutureRollbackCountSqlRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): FutureRollbackCountSqlRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseFutureRollbackCountSqlRequest();
  ...
  fromJSON(object: any): FutureRollbackCountSqlRequest {
    return {
  ...
  toJSON(message: FutureRollbackCountSqlRequest): unknown {
    const obj: any = {};
    if (message.changeExecListenerClass !== undefined) {
  ...
  create<I extends Exact<DeepPartial<FutureRollbackCountSqlRequest>, I>>(base?: I): FutureRollbackCountSqlRequest {
    return FutureRollbackCountSqlRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FutureRollbackCountSqlRequest>, I>>(
    object: I,
  ): FutureRollbackCountSqlRequest {
    const message = createBaseFutureRollbackCountSqlRequest();
...
export interface FutureRollbackCountSqlService {
  execute(request: FutureRollbackCountSqlRequest): Promise<Response>;
}

export const FutureRollbackCountSqlServiceServiceName = "liquibase.FutureRollbackCountSqlService";
export class FutureRollbackCountSqlServiceClientImpl implements FutureRollbackCountSqlService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || FutureRollbackCountSqlServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: FutureRollbackCountSqlRequest): Promise<Response> {
    const data = FutureRollbackCountSqlRequest.encode(request).finish();
