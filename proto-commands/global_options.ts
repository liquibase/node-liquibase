...
function createBaseGlobalOptions(): GlobalOptions {
  return {
    ...
    proGlobalStripComments: undefined,
    proGlobalStripCommentsPrioritized: undefined,
    ...
    suppressLiquibaseSql: undefined,
...
export const GlobalOptions = {
  encode(message: GlobalOptions, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.proGlobalStripComments !== undefined) {
      writer.uint32(480).bool(message.proGlobalStripComments);
    }
    if (message.proGlobalStripCommentsPrioritized !== undefined) {
      writer.uint32(488).bool(message.proGlobalStripCommentsPrioritized);
    }
    if (message.proLicenseKey !== undefined) {
      writer.uint32(498).string(message.proLicenseKey);
    }
    if (message.proMarkUnusedNotDrop !== undefined) {
      writer.uint32(504).bool(message.proMarkUnusedNotDrop);
    }
    if (message.proSqlInline !== undefined) {
      writer.uint32(512).bool(message.proSqlInline);
    }
    if (message.proSynonymsDropPublic !== undefined) {
      writer.uint32(520).bool(message.proSynonymsDropPublic);
    }
    if (message.proStrict !== undefined) {
      writer.uint32(528).bool(message.proStrict);
    }
    if (message.promptForNonLocalDatabase !== undefined) {
      writer.uint32(536).bool(message.promptForNonLocalDatabase);
    }
    if (message.propertyProviderClass !== undefined) {
      writer.uint32(546).string(message.propertyProviderClass);
    }
    if (message.reportsEnabled !== undefined) {
      writer.uint32(552).bool(message.reportsEnabled);
    }
    if (message.reportsFormat !== undefined) {
      writer.uint32(562).string(message.reportsFormat);
    }
    if (message.reportsName !== undefined) {
      writer.uint32(570).string(message.reportsName);
    }
    if (message.reportsOpen !== undefined) {
      writer.uint32(576).bool(message.reportsOpen);
    }
    if (message.reportsPath !== undefined) {
      writer.uint32(586).string(message.reportsPath);
    }
    if (message.reportsQuiet !== undefined) {
      writer.uint32(592).bool(message.reportsQuiet);
    }
    if (message.searchPath !== undefined) {
      writer.uint32(602).string(message.searchPath);
    }
    if (message.secureParsing !== undefined) {
      writer.uint32(608).bool(message.secureParsing);
    }
    if (message.shouldRun !== undefined) {
      writer.uint32(616).bool(message.shouldRun);
    }
    if (message.shouldSnapshotData !== undefined) {
      writer.uint32(624).bool(message.shouldSnapshotData);
    }
    if (message.showBanner !== undefined) {
      writer.uint32(632).bool(message.showBanner);
    }
    if (message.showHiddenArgs !== undefined) {
      writer.uint32(640).bool(message.showHiddenArgs);
    }
    if (message.sqlAlwaysSetFetchSize !== undefined) {
      writer.uint32(648).bool(message.sqlAlwaysSetFetchSize);
    }
    if (message.sqlLogLevel !== undefined) {
      writer.uint32(658).string(message.sqlLogLevel);
    }
    if (message.sqlShowSqlWarnings !== undefined) {
      writer.uint32(664).bool(message.sqlShowSqlWarnings);
    }
    if (message.strict !== undefined) {
      writer.uint32(672).bool(message.strict);
    }
    if (message.supportPropertyEscaping !== undefined) {
      writer.uint32(680).bool(message.supportPropertyEscaping);
    }
    if (message.supportsMethodValidationLevel !== undefined) {
      writer.uint32(690).string(message.supportsMethodValidationLevel);
    }
    if (message.suppressLiquibaseSql !== undefined) {
      writer.uint32(696).bool(message.suppressLiquibaseSql);
    }
    if (message.trimLoadDataFileHeader !== undefined) {
      writer.uint32(704).bool(message.trimLoadDataFileHeader);
    }
    if (message.uiService !== undefined) {
      writer.uint32(714).string(message.uiService);
    }
    if (message.useProcedureSchema !== undefined) {
      writer.uint32(720).bool(message.useProcedureSchema);
    }
    if (message.validateXmlChangelogFiles !== undefined) {
      writer.uint32(728).bool(message.validateXmlChangelogFiles);
    }
    if (message.workaroundOracleClobCharacterLimit !== undefined) {
      writer.uint32(736).bool(message.workaroundOracleClobCharacterLimit);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 60:
          ...
          message.proGlobalStripComments = reader.bool();
          continue;
        case 61:
          if (tag !== 488) {
            break;
          ...
          message.proGlobalStripCommentsPrioritized = reader.bool();
          continue;
        case 62:
          if (tag !== 498) {
            break;
        ...
        case 87:
          ...
          message.suppressLiquibaseSql = reader.bool();
          continue;
        case 88:
          if (tag !== 704) {
            break;
  ...
  fromJSON(object: any): GlobalOptions {
    return {
      ...
      proGlobalEndDelimiterPrioritized: isSet(object.proGlobalEndDelimiterPrioritized)
        ...
        : undefined,
      proGlobalStripComments: isSet(object.proGlobalStripComments)
        ? globalThis.Boolean(object.proGlobalStripComments)
        : undefined,
      proGlobalStripCommentsPrioritized: isSet(object.proGlobalStripCommentsPrioritized)
        ? globalThis.Boolean(object.proGlobalStripCommentsPrioritized)
        : undefined,
      ...
      supportsMethodValidationLevel: isSet(object.supportsMethodValidationLevel)
        ...
        : undefined,
      suppressLiquibaseSql: isSet(object.suppressLiquibaseSql)
        ? globalThis.Boolean(object.suppressLiquibaseSql)
        : undefined,
  ...
  toJSON(message: GlobalOptions): unknown {
    ...
    if (message.proGlobalStripComments !== undefined) {
      obj.proGlobalStripComments = message.proGlobalStripComments;
    }
    if (message.proGlobalStripCommentsPrioritized !== undefined) {
      obj.proGlobalStripCommentsPrioritized = message.proGlobalStripCommentsPrioritized;
    }
    if (message.proLicenseKey !== undefined) {
    ...
    if (message.suppressLiquibaseSql !== undefined) {
      obj.suppressLiquibaseSql = message.suppressLiquibaseSql;
    }
    if (message.trimLoadDataFileHeader !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<GlobalOptions>, I>>(object: I): GlobalOptions {
    ...
    message.proGlobalStripComments = object.proGlobalStripComments ?? undefined;
    message.proGlobalStripCommentsPrioritized = object.proGlobalStripCommentsPrioritized ?? undefined;
    ...
    message.suppressLiquibaseSql = object.suppressLiquibaseSql ?? undefined;
