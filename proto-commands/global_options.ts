...
export const GlobalOptions = {
  encode(message: GlobalOptions, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.searchPath !== undefined) {
      writer.uint32(578).string(message.searchPath);
    }
    if (message.secureParsing !== undefined) {
      writer.uint32(584).bool(message.secureParsing);
    }
    if (message.shouldRun !== undefined) {
      writer.uint32(592).bool(message.shouldRun);
    }
    if (message.shouldSnapshotData !== undefined) {
      writer.uint32(600).bool(message.shouldSnapshotData);
    }
    if (message.showBanner !== undefined) {
      writer.uint32(608).bool(message.showBanner);
    }
    if (message.showHiddenArgs !== undefined) {
      writer.uint32(616).bool(message.showHiddenArgs);
    }
    if (message.sqlAlwaysSetFetchSize !== undefined) {
      writer.uint32(624).bool(message.sqlAlwaysSetFetchSize);
    }
    if (message.sqlLogLevel !== undefined) {
      writer.uint32(634).string(message.sqlLogLevel);
    }
    if (message.sqlShowSqlWarnings !== undefined) {
      writer.uint32(640).bool(message.sqlShowSqlWarnings);
    }
    if (message.strict !== undefined) {
      writer.uint32(648).bool(message.strict);
    }
    if (message.supportPropertyEscaping !== undefined) {
      writer.uint32(656).bool(message.supportPropertyEscaping);
    }
    if (message.uiService !== undefined) {
      writer.uint32(666).string(message.uiService);
    }
    if (message.useProcedureSchema !== undefined) {
      writer.uint32(672).bool(message.useProcedureSchema);
    }
    if (message.validateXmlChangelogFiles !== undefined) {
      writer.uint32(680).bool(message.validateXmlChangelogFiles);
    }
    if (message.workaroundOracleClobCharacterLimit !== undefined) {
      writer.uint32(688).bool(message.workaroundOracleClobCharacterLimit);
    }
    return writer;
  },
