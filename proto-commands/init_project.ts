...
export const Init_ProjectRequest = {
  encode(message: Init_ProjectRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.projectGuide !== undefined) {
      writer.uint32(56).bool(message.projectGuide);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          message.projectGuide = reader.bool();
          continue;
        case 8:
          if (tag !== 66) {
            break;
  ...
  fromJSON(object: any): Init_ProjectRequest {
    return {
      ...
      projectGuide: isSet(object.projectGuide) ? globalThis.Boolean(object.projectGuide) : undefined,
