...
export interface MarkNextChangesetRanRequest {
...
function createBaseMarkNextChangesetRanRequest(): MarkNextChangesetRanRequest {
  return {
    changelogFile: "",
...
export const MarkNextChangesetRanRequest = {
  encode(message: MarkNextChangesetRanRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MarkNextChangesetRanRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMarkNextChangesetRanRequest();
  ...
  fromJSON(object: any): MarkNextChangesetRanRequest {
    return {
  ...
  toJSON(message: MarkNextChangesetRanRequest): unknown {
    const obj: any = {};
    if (message.changelogFile !== "") {
  ...
  create<I extends Exact<DeepPartial<MarkNextChangesetRanRequest>, I>>(base?: I): MarkNextChangesetRanRequest {
    return MarkNextChangesetRanRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MarkNextChangesetRanRequest>, I>>(object: I): MarkNextChangesetRanRequest {
    const message = createBaseMarkNextChangesetRanRequest();
...
export interface MarkNextChangesetRanService {
  execute(request: MarkNextChangesetRanRequest): Promise<Response>;
}

export const MarkNextChangesetRanServiceServiceName = "liquibase.MarkNextChangesetRanService";
export class MarkNextChangesetRanServiceClientImpl implements MarkNextChangesetRanService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || MarkNextChangesetRanServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: MarkNextChangesetRanRequest): Promise<Response> {
    const data = MarkNextChangesetRanRequest.encode(request).finish();
