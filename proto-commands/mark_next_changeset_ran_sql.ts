...
export interface MarkNextChangesetRanSqlRequest {
...
function createBaseMarkNextChangesetRanSqlRequest(): MarkNextChangesetRanSqlRequest {
  return {
    changelogFile: "",
...
export const MarkNextChangesetRanSqlRequest = {
  encode(message: MarkNextChangesetRanSqlRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MarkNextChangesetRanSqlRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMarkNextChangesetRanSqlRequest();
  ...
  fromJSON(object: any): MarkNextChangesetRanSqlRequest {
    return {
  ...
  toJSON(message: MarkNextChangesetRanSqlRequest): unknown {
    const obj: any = {};
    if (message.changelogFile !== "") {
  ...
  create<I extends Exact<DeepPartial<MarkNextChangesetRanSqlRequest>, I>>(base?: I): MarkNextChangesetRanSqlRequest {
    return MarkNextChangesetRanSqlRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MarkNextChangesetRanSqlRequest>, I>>(
    object: I,
  ): MarkNextChangesetRanSqlRequest {
    const message = createBaseMarkNextChangesetRanSqlRequest();
...
export interface MarkNextChangesetRanSqlService {
  execute(request: MarkNextChangesetRanSqlRequest): Promise<Response>;
}

export const MarkNextChangesetRanSqlServiceServiceName = "liquibase.MarkNextChangesetRanSqlService";
export class MarkNextChangesetRanSqlServiceClientImpl implements MarkNextChangesetRanSqlService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || MarkNextChangesetRanSqlServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: MarkNextChangesetRanSqlRequest): Promise<Response> {
    const data = MarkNextChangesetRanSqlRequest.encode(request).finish();
