...
function createBaseReleaseLocksRequest(): ReleaseLocksRequest {
  return {
...
export const ReleaseLocksRequest = {
  encode(message: ReleaseLocksRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ReleaseLocksRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseReleaseLocksRequest();
  ...
  fromJSON(object: any): ReleaseLocksRequest {
    return {
  ...
  toJSON(message: ReleaseLocksRequest): unknown {
    const obj: any = {};
    if (message.defaultCatalogName !== undefined) {
  ...
  create<I extends Exact<DeepPartial<ReleaseLocksRequest>, I>>(base?: I): ReleaseLocksRequest {
    return ReleaseLocksRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ReleaseLocksRequest>, I>>(object: I): ReleaseLocksRequest {
    const message = createBaseReleaseLocksRequest();
...
export interface ReleaseLocksService {
  execute(request: ReleaseLocksRequest): Promise<Response>;
}

export const ReleaseLocksServiceServiceName = "liquibase.ReleaseLocksService";
export class ReleaseLocksServiceClientImpl implements ReleaseLocksService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || ReleaseLocksServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: ReleaseLocksRequest): Promise<Response> {
    const data = ReleaseLocksRequest.encode(request).finish();
