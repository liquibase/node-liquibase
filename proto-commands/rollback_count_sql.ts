...
function createBaseRollbackCountSqlRequest(): RollbackCountSqlRequest {
  return {
...
export const RollbackCountSqlRequest = {
  encode(message: RollbackCountSqlRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RollbackCountSqlRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRollbackCountSqlRequest();
  ...
  fromJSON(object: any): RollbackCountSqlRequest {
    return {
  ...
  toJSON(message: RollbackCountSqlRequest): unknown {
    const obj: any = {};
    if (message.changeExecListenerClass !== undefined) {
  ...
  create<I extends Exact<DeepPartial<RollbackCountSqlRequest>, I>>(base?: I): RollbackCountSqlRequest {
    return RollbackCountSqlRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RollbackCountSqlRequest>, I>>(object: I): RollbackCountSqlRequest {
    const message = createBaseRollbackCountSqlRequest();
...
export interface RollbackCountSqlService {
  execute(request: RollbackCountSqlRequest): Promise<Response>;
}

export const RollbackCountSqlServiceServiceName = "liquibase.RollbackCountSqlService";
export class RollbackCountSqlServiceClientImpl implements RollbackCountSqlService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || RollbackCountSqlServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: RollbackCountSqlRequest): Promise<Response> {
    const data = RollbackCountSqlRequest.encode(request).finish();
