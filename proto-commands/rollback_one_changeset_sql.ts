 ...
 */
export interface RollbackOneChangesetSqlRequest {
...
function createBaseRollbackOneChangesetSqlRequest(): RollbackOneChangesetSqlRequest {
  return {
...
export const RollbackOneChangesetSqlRequest = {
  encode(message: RollbackOneChangesetSqlRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.changesetAuthor !== "") {
      writer.uint32(34).string(message.changesetAuthor);
    }
    if (message.changesetId !== "") {
      writer.uint32(42).string(message.changesetId);
    }
    if (message.changesetPath !== "") {
      writer.uint32(50).string(message.changesetPath);
    }
    if (message.contextFilter !== undefined) {
      writer.uint32(58).string(message.contextFilter);
    }
    if (message.defaultCatalogName !== undefined) {
      writer.uint32(66).string(message.defaultCatalogName);
    }
    if (message.defaultSchemaName !== undefined) {
      writer.uint32(74).string(message.defaultSchemaName);
    }
    if (message.driver !== undefined) {
      writer.uint32(82).string(message.driver);
    }
    if (message.driverPropertiesFile !== undefined) {
      writer.uint32(90).string(message.driverPropertiesFile);
    }
    if (message.labelFilter !== undefined) {
      writer.uint32(98).string(message.labelFilter);
    }
    if (message.outputDefaultCatalog !== undefined) {
      writer.uint32(104).bool(message.outputDefaultCatalog);
    }
    if (message.outputDefaultSchema !== undefined) {
      writer.uint32(112).bool(message.outputDefaultSchema);
    }
    if (message.password !== undefined) {
      writer.uint32(122).string(message.password);
    }
    if (message.rollbackScript !== undefined) {
      writer.uint32(130).string(message.rollbackScript);
    }
    if (message.url !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RollbackOneChangesetSqlRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRollbackOneChangesetSqlRequest();
  ...
  fromJSON(object: any): RollbackOneChangesetSqlRequest {
    return {
      ...
      changesetAuthor: isSet(object.changesetAuthor) ? globalThis.String(object.changesetAuthor) : "",
      changesetId: isSet(object.changesetId) ? globalThis.String(object.changesetId) : "",
      changesetPath: isSet(object.changesetPath) ? globalThis.String(object.changesetPath) : "",
  ...
  toJSON(message: RollbackOneChangesetSqlRequest): unknown {
    const obj: any = {};
    if (message.changeExecListenerClass !== undefined) {
  ...
  create<I extends Exact<DeepPartial<RollbackOneChangesetSqlRequest>, I>>(base?: I): RollbackOneChangesetSqlRequest {
    return RollbackOneChangesetSqlRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RollbackOneChangesetSqlRequest>, I>>(
    object: I,
  ): RollbackOneChangesetSqlRequest {
    const message = createBaseRollbackOneChangesetSqlRequest();
    ...
    message.changesetAuthor = object.changesetAuthor ?? "";
    message.changesetId = object.changesetId ?? "";
    message.changesetPath = object.changesetPath ?? "";
...
export interface RollbackOneChangesetSqlService {
  execute(request: RollbackOneChangesetSqlRequest): Promise<Response>;
}

export const RollbackOneChangesetSqlServiceServiceName = "liquibase.RollbackOneChangesetSqlService";
export class RollbackOneChangesetSqlServiceClientImpl implements RollbackOneChangesetSqlService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || RollbackOneChangesetSqlServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: RollbackOneChangesetSqlRequest): Promise<Response> {
    const data = RollbackOneChangesetSqlRequest.encode(request).finish();
