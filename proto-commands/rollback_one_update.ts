 ...
 */
export interface RollbackOneUpdateRequest {
...
function createBaseRollbackOneUpdateRequest(): RollbackOneUpdateRequest {
  return {
...
export const RollbackOneUpdateRequest = {
  encode(message: RollbackOneUpdateRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.force !== undefined) {
      writer.uint32(80).bool(message.force);
    }
    if (message.labelFilter !== undefined) {
      writer.uint32(90).string(message.labelFilter);
    }
    if (message.password !== undefined) {
      writer.uint32(98).string(message.password);
    }
    if (message.reportEnabled !== undefined) {
      writer.uint32(104).bool(message.reportEnabled);
    }
    if (message.reportName !== undefined) {
      writer.uint32(114).string(message.reportName);
    }
    if (message.reportPath !== undefined) {
      writer.uint32(122).string(message.reportPath);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RollbackOneUpdateRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRollbackOneUpdateRequest();
  ...
  fromJSON(object: any): RollbackOneUpdateRequest {
    return {
  ...
  toJSON(message: RollbackOneUpdateRequest): unknown {
    const obj: any = {};
    if (message.changeExecListenerClass !== undefined) {
  ...
  create<I extends Exact<DeepPartial<RollbackOneUpdateRequest>, I>>(base?: I): RollbackOneUpdateRequest {
    return RollbackOneUpdateRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RollbackOneUpdateRequest>, I>>(object: I): RollbackOneUpdateRequest {
    const message = createBaseRollbackOneUpdateRequest();
...
export interface RollbackOneUpdateService {
  execute(request: RollbackOneUpdateRequest): Promise<Response>;
}

export const RollbackOneUpdateServiceServiceName = "liquibase.RollbackOneUpdateService";
export class RollbackOneUpdateServiceClientImpl implements RollbackOneUpdateService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || RollbackOneUpdateServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: RollbackOneUpdateRequest): Promise<Response> {
    const data = RollbackOneUpdateRequest.encode(request).finish();
