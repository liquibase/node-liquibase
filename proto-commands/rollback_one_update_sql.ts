 ...
 */
export interface RollbackOneUpdateSqlRequest {
...
function createBaseRollbackOneUpdateSqlRequest(): RollbackOneUpdateSqlRequest {
  return {
...
export const RollbackOneUpdateSqlRequest = {
  encode(message: RollbackOneUpdateSqlRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.rollbackScript !== undefined) {
      writer.uint32(114).string(message.rollbackScript);
    }
    if (message.url !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RollbackOneUpdateSqlRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRollbackOneUpdateSqlRequest();
  ...
  fromJSON(object: any): RollbackOneUpdateSqlRequest {
    return {
  ...
  toJSON(message: RollbackOneUpdateSqlRequest): unknown {
    const obj: any = {};
    if (message.changeExecListenerClass !== undefined) {
  ...
  create<I extends Exact<DeepPartial<RollbackOneUpdateSqlRequest>, I>>(base?: I): RollbackOneUpdateSqlRequest {
    return RollbackOneUpdateSqlRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RollbackOneUpdateSqlRequest>, I>>(object: I): RollbackOneUpdateSqlRequest {
    const message = createBaseRollbackOneUpdateSqlRequest();
...
export interface RollbackOneUpdateSqlService {
  execute(request: RollbackOneUpdateSqlRequest): Promise<Response>;
}

export const RollbackOneUpdateSqlServiceServiceName = "liquibase.RollbackOneUpdateSqlService";
export class RollbackOneUpdateSqlServiceClientImpl implements RollbackOneUpdateSqlService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || RollbackOneUpdateSqlServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: RollbackOneUpdateSqlRequest): Promise<Response> {
    const data = RollbackOneUpdateSqlRequest.encode(request).finish();
