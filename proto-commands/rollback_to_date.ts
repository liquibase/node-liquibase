...
export interface RollbackToDateRequest {
...
function createBaseRollbackToDateRequest(): RollbackToDateRequest {
  return {
...
export const RollbackToDateRequest = {
  encode(message: RollbackToDateRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RollbackToDateRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRollbackToDateRequest();
  ...
  fromJSON(object: any): RollbackToDateRequest {
    return {
  ...
  toJSON(message: RollbackToDateRequest): unknown {
    const obj: any = {};
    if (message.changeExecListenerClass !== undefined) {
  ...
  create<I extends Exact<DeepPartial<RollbackToDateRequest>, I>>(base?: I): RollbackToDateRequest {
    return RollbackToDateRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RollbackToDateRequest>, I>>(object: I): RollbackToDateRequest {
    const message = createBaseRollbackToDateRequest();
...
export interface RollbackToDateService {
  execute(request: RollbackToDateRequest): Promise<Response>;
}

export const RollbackToDateServiceServiceName = "liquibase.RollbackToDateService";
export class RollbackToDateServiceClientImpl implements RollbackToDateService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || RollbackToDateServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: RollbackToDateRequest): Promise<Response> {
    const data = RollbackToDateRequest.encode(request).finish();
