...
export interface RollbackToDateSqlRequest {
  ...
  /** required* Date to rollback changes to */
  date: string;
...
function createBaseRollbackToDateSqlRequest(): RollbackToDateSqlRequest {
  return {
...
export const RollbackToDateSqlRequest = {
  encode(message: RollbackToDateSqlRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RollbackToDateSqlRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRollbackToDateSqlRequest();
  ...
  fromJSON(object: any): RollbackToDateSqlRequest {
    return {
  ...
  toJSON(message: RollbackToDateSqlRequest): unknown {
    const obj: any = {};
    if (message.changeExecListenerClass !== undefined) {
  ...
  create<I extends Exact<DeepPartial<RollbackToDateSqlRequest>, I>>(base?: I): RollbackToDateSqlRequest {
    return RollbackToDateSqlRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RollbackToDateSqlRequest>, I>>(object: I): RollbackToDateSqlRequest {
    const message = createBaseRollbackToDateSqlRequest();
...
export interface RollbackToDateSqlService {
  execute(request: RollbackToDateSqlRequest): Promise<Response>;
}

export const RollbackToDateSqlServiceServiceName = "liquibase.RollbackToDateSqlService";
export class RollbackToDateSqlServiceClientImpl implements RollbackToDateSqlService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || RollbackToDateSqlServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: RollbackToDateSqlRequest): Promise<Response> {
    const data = RollbackToDateSqlRequest.encode(request).finish();
