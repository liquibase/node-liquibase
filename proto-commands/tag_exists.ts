...
export interface TagExistsRequest {
...
function createBaseTagExistsRequest(): TagExistsRequest {
  return {
...
export const TagExistsRequest = {
  encode(message: TagExistsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TagExistsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseTagExistsRequest();
  ...
  fromJSON(object: any): TagExistsRequest {
    return {
  ...
  toJSON(message: TagExistsRequest): unknown {
    const obj: any = {};
    if (message.defaultCatalogName !== undefined) {
  ...
  create<I extends Exact<DeepPartial<TagExistsRequest>, I>>(base?: I): TagExistsRequest {
    return TagExistsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TagExistsRequest>, I>>(object: I): TagExistsRequest {
    const message = createBaseTagExistsRequest();
...
export interface TagExistsService {
  execute(request: TagExistsRequest): Promise<Response>;
}

export const TagExistsServiceServiceName = "liquibase.TagExistsService";
export class TagExistsServiceClientImpl implements TagExistsService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || TagExistsServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: TagExistsRequest): Promise<Response> {
    const data = TagExistsRequest.encode(request).finish();
