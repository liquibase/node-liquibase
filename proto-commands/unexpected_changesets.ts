...
export interface UnexpectedChangesetsRequest {
...
function createBaseUnexpectedChangesetsRequest(): UnexpectedChangesetsRequest {
  return {
    changelogFile: "",
...
export const UnexpectedChangesetsRequest = {
  encode(message: UnexpectedChangesetsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UnexpectedChangesetsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUnexpectedChangesetsRequest();
  ...
  fromJSON(object: any): UnexpectedChangesetsRequest {
    return {
  ...
  toJSON(message: UnexpectedChangesetsRequest): unknown {
    const obj: any = {};
    if (message.changelogFile !== "") {
  ...
  create<I extends Exact<DeepPartial<UnexpectedChangesetsRequest>, I>>(base?: I): UnexpectedChangesetsRequest {
    return UnexpectedChangesetsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UnexpectedChangesetsRequest>, I>>(object: I): UnexpectedChangesetsRequest {
    const message = createBaseUnexpectedChangesetsRequest();
...
export interface UnexpectedChangesetsService {
  execute(request: UnexpectedChangesetsRequest): Promise<Response>;
}

export const UnexpectedChangesetsServiceServiceName = "liquibase.UnexpectedChangesetsService";
export class UnexpectedChangesetsServiceClientImpl implements UnexpectedChangesetsService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || UnexpectedChangesetsServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: UnexpectedChangesetsRequest): Promise<Response> {
    const data = UnexpectedChangesetsRequest.encode(request).finish();
