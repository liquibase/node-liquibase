 ...
 */
export interface UpdateOneChangesetRequest {
...
function createBaseUpdateOneChangesetRequest(): UpdateOneChangesetRequest {
  return {
...
export const UpdateOneChangesetRequest = {
  encode(message: UpdateOneChangesetRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.force !== undefined) {
      writer.uint32(96).bool(message.force);
    }
    if (message.labelFilter !== undefined) {
      writer.uint32(106).string(message.labelFilter);
    }
    ...
    if (message.rollbackOnError !== undefined) {
      writer.uint32(144).bool(message.rollbackOnError);
    }
    if (message.url !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UpdateOneChangesetRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpdateOneChangesetRequest();
  ...
  fromJSON(object: any): UpdateOneChangesetRequest {
    return {
  ...
  toJSON(message: UpdateOneChangesetRequest): unknown {
    const obj: any = {};
    if (message.changeExecListenerClass !== undefined) {
  ...
  create<I extends Exact<DeepPartial<UpdateOneChangesetRequest>, I>>(base?: I): UpdateOneChangesetRequest {
    return UpdateOneChangesetRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UpdateOneChangesetRequest>, I>>(object: I): UpdateOneChangesetRequest {
    const message = createBaseUpdateOneChangesetRequest();
...
export interface UpdateOneChangesetService {
  execute(request: UpdateOneChangesetRequest): Promise<Response>;
}

export const UpdateOneChangesetServiceServiceName = "liquibase.UpdateOneChangesetService";
export class UpdateOneChangesetServiceClientImpl implements UpdateOneChangesetService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || UpdateOneChangesetServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: UpdateOneChangesetRequest): Promise<Response> {
    const data = UpdateOneChangesetRequest.encode(request).finish();
