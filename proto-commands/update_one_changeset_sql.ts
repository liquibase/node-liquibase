 ...
 */
export interface UpdateOneChangesetSqlRequest {
...
function createBaseUpdateOneChangesetSqlRequest(): UpdateOneChangesetSqlRequest {
  return {
...
export const UpdateOneChangesetSqlRequest = {
  encode(message: UpdateOneChangesetSqlRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UpdateOneChangesetSqlRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpdateOneChangesetSqlRequest();
  ...
  fromJSON(object: any): UpdateOneChangesetSqlRequest {
    return {
  ...
  toJSON(message: UpdateOneChangesetSqlRequest): unknown {
    const obj: any = {};
    if (message.changeExecListenerClass !== undefined) {
  ...
  create<I extends Exact<DeepPartial<UpdateOneChangesetSqlRequest>, I>>(base?: I): UpdateOneChangesetSqlRequest {
    return UpdateOneChangesetSqlRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UpdateOneChangesetSqlRequest>, I>>(object: I): UpdateOneChangesetSqlRequest {
    const message = createBaseUpdateOneChangesetSqlRequest();
...
export interface UpdateOneChangesetSqlService {
  execute(request: UpdateOneChangesetSqlRequest): Promise<Response>;
}

export const UpdateOneChangesetSqlServiceServiceName = "liquibase.UpdateOneChangesetSqlService";
export class UpdateOneChangesetSqlServiceClientImpl implements UpdateOneChangesetSqlService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || UpdateOneChangesetSqlServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: UpdateOneChangesetSqlRequest): Promise<Response> {
    const data = UpdateOneChangesetSqlRequest.encode(request).finish();
