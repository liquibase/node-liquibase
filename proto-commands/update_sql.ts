...
function createBaseUpdateSqlRequest(): UpdateSqlRequest {
  return {
...
export const UpdateSqlRequest = {
  encode(message: UpdateSqlRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UpdateSqlRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpdateSqlRequest();
  ...
  fromJSON(object: any): UpdateSqlRequest {
    return {
  ...
  toJSON(message: UpdateSqlRequest): unknown {
    const obj: any = {};
    if (message.changeExecListenerClass !== undefined) {
  ...
  create<I extends Exact<DeepPartial<UpdateSqlRequest>, I>>(base?: I): UpdateSqlRequest {
    return UpdateSqlRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UpdateSqlRequest>, I>>(object: I): UpdateSqlRequest {
    const message = createBaseUpdateSqlRequest();
...
export interface UpdateSqlService {
  execute(request: UpdateSqlRequest): Promise<Response>;
}

export const UpdateSqlServiceServiceName = "liquibase.UpdateSqlService";
export class UpdateSqlServiceClientImpl implements UpdateSqlService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || UpdateSqlServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: UpdateSqlRequest): Promise<Response> {
    const data = UpdateSqlRequest.encode(request).finish();
