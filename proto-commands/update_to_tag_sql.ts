...
export interface UpdateToTagSqlRequest {
  ...
  password?: string;
  /** required* The tag to generate SQL up to */
  tag: string;
...
function createBaseUpdateToTagSqlRequest(): UpdateToTagSqlRequest {
  return {
...
export const UpdateToTagSqlRequest = {
  encode(message: UpdateToTagSqlRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UpdateToTagSqlRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpdateToTagSqlRequest();
  ...
  fromJSON(object: any): UpdateToTagSqlRequest {
    return {
  ...
  toJSON(message: UpdateToTagSqlRequest): unknown {
    const obj: any = {};
    if (message.changeExecListenerClass !== undefined) {
  ...
  create<I extends Exact<DeepPartial<UpdateToTagSqlRequest>, I>>(base?: I): UpdateToTagSqlRequest {
    return UpdateToTagSqlRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UpdateToTagSqlRequest>, I>>(object: I): UpdateToTagSqlRequest {
    const message = createBaseUpdateToTagSqlRequest();
...
export interface UpdateToTagSqlService {
  execute(request: UpdateToTagSqlRequest): Promise<Response>;
}

export const UpdateToTagSqlServiceServiceName = "liquibase.UpdateToTagSqlService";
export class UpdateToTagSqlServiceClientImpl implements UpdateToTagSqlService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || UpdateToTagSqlServiceServiceName;
    this.rpc = rpc;
    this.execute = this.execute.bind(this);
  }
  execute(request: UpdateToTagSqlRequest): Promise<Response> {
    const data = UpdateToTagSqlRequest.encode(request).finish();
